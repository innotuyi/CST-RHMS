            ...
            <Form className="form">
              <Col>
                <FormGroup>
                  ...
                  <Input invalid={username.message !=null} onChange={onUserChange} type="text" name="text" placeholder="Enter your username" />
                <FormFeedback invalid={username.message != null}>{username.message}</FormFeedback>
                </FormGroup>
                               <FormGroup>
                  <Label>Email</Label>
              ...
              <Col>
                ...
                <FormGroup>
                  ...
                  <Input invalid={confirm.message != null} onChange={onConfirmChange} type="password" name="password" placeholder="Enter your Password"
                  />
                  <FormFeedback invalid={confirm.message != null}>{confirm.message}</FormFeedback>
                </FormGroup>
              </Col>
              <Button onClick={handleContinue} className='buttons mt-3' color="primary">Continue</Button>
            </Form>
          </div>
        </div>
      </div>
