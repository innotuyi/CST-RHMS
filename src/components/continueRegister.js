...
function continueRegister(props) {
                        ...
                        <Form>
                            <Col>
                                <FormGroup>
                                    ...
                                    <Input invalid={firstname.message != null} onChange={onNameChange} type="text" name="firstname" placeholder="Enter your first name" />
                                    <FormFeedback invalid={firstname.message != null}>{firstname.message}</FormFeedback>
                                </FormGroup>
                                <FormGroup>
                                    <Label>Last Name</Label>
                                    <Input invalid={lastname.message != null} onChange={onLastChange} type="text" name="lastname" placeholder="Enter your last name" />
                                ...
                                <FormGroup>
                                    ...
                                    <Row>
                                        ...
                                        <Col>
                                            <FormGroup>
                                                ...
                                                <Input invalid={depart.message != null} type="select" name="depart" placeholder="Select your department" onChange={onDepartChange}>
                                    ...
                                    <FormGroup>
                                        ...
                                        <Input invalid={rank.message} type="select" name="rank" id="exampleSelect" onChange={onRankChange}>
                                    ...
                                    <Input invalid={specialization.message} type="text" name="specialization" placeholder="Enter your area of specialization" onChange={onSpecializationChange} />
                                    <FormFeedback invalid={specialization.message != null}>{specialization.message}</FormFeedback>
                                </FormGroup>
                                <FormGroup>
                                    <Label>Responsibilities</Label>
                                    <Input invalid={resp.message} type="text" name="resp" placeholder="Enter responsibilities" onChange={onResponsibilityChange} />
                                    <FormFeedback invalid={resp.message != null}>{resp.message}</FormFeedback>
                                </FormGroup>
                                <FormGroup>
                                    <Label>Trainings</Label>
                                    <Input invalid={train.message} type="text" name="train" placeholder="Trainings you attended" onChange={onTrainingChange} />
                                    <FormFeedback invalid={train.message != null}>{train.message}</FormFeedback>
                                </FormGroup>
                                <Button  className='buttons mt-3' color="primary" onClick={submitHandler}>Register</Button>
