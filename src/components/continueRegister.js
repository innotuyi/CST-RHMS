  ...
  const onSpecializationChange = (e) => {
    ...
    if (specialization != "") {
      ...
      setSpecialization({
        ...
        message: "Write your specialization",
      });
    }
  };
            ...
            <Form>
              <Col>
                ...
                <FormGroup>
                    ...
                    <Col>
                      <FormGroup>
                        ...
                        >
                          ...
                          <option>So-ICT</option>
                          <option>So-ENG</option>
                          <option>So-ARCH</option>
                          <option>So-MN</option>
                        </Input>
                  ...
                  <Row>
                    <Col>
                      <FormGroup>
                        ...
                        />
                        <FormFeedback invalid={date.message != null}>
                          {date.message}
                        </FormFeedback>
                      </FormGroup>
                    </Col>
                    <Col>
                      <FormGroup>
                        ...
                        />
                        <FormFeedback invalid={proDate.message != null}>
                          {proDate.message}
                        </FormFeedback>
                      </FormGroup>
                    </Col>
                  ...
                  <Input
                    invalid={specialization.message}
                    type="text"
                    name="specialization"
                    placeholder="Enter your area of specialization"
                    onChange={onSpecializationChange}
                  />
                  <FormFeedback invalid={specialization.message != null}>
                ...
                <FormGroup>
                  ...
                  <Input
                    invalid={train.message}
                    type="text"
                    name="train"
                    placeholder="Trainings you attended"
                    onChange={onTrainingChange}
                  />
                  <FormFeedback invalid={train.message != null}>
                    {train.message}
                  </FormFeedback>
                </FormGroup>
                <Button
