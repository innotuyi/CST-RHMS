  ...
  useEffect(() => {
    async function fetchProducts() {
      const { data } = await axios.get(
        `http://127.0.0.1:8000/admin-statistic/all-research-conferance/${id}`,
        {
          headers: {
  ...
  const submitHandler = (e) => {
    ...
    axios
      ...
      .then(function (response) {
        ...
        history.push("/ConferenceBasedAdmin");
      })
...
export default EditConferenceAdmin;
